        ...
        <ul className="bullets type-guide">
          ...
          <li>
            ...
            <p className="tg-train">
              ...
              적습니다. 새 기호가 나오면 문제에 딸린 예시에 넣어 검산해 보는 것이 첫 단추입니다.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p className="tg-train">
              ...
              대개 첫 단계가 아니라 두 번째 단계를 못 떠올립니다. 풀이를 끊어 번호를 붙이는 습관이 약입니다.
            </p>
          </li>
          <li>
      ...
      <section className="assess-card">
        ...
        <ul className="bullets" style={{ marginTop: 12 }}>
          ...
          <li>
            ...
            <b>표준·상은 8점, 최상은 5점</b>. 합이 <b>40점에 닿으면 재수강 권장</b>입니다. 표준·상만 틀리면 5개,
          ...
          <li>
            그 아래 <b>기초</b>와 <b>심화</b>를 따로 보여 줍니다. 같은 개수를 틀려도 표준을 흘린 학생과 최상만 못 푼
            학생은 처방이 다릅니다. 표준을 <b>2개 이상</b> 틀리면 <b>기초 미달</b>(지난 학기를 다시 봐야 함),
            최상을 <b>5개 이상</b> 틀리면 <b>심화 미달</b>(더 어려운 문제를 줘야 함)입니다. <b>재수강이 아니어도</b>
            {' '}따로 뜹니다 — 최상 5개는 25점이라 통과지만 심화는 비어 있는 것이니까요.
          </li>
          <li>
            <b>이 판정들은 리포트에 나가지 않습니다.</b> 등급은 전국에서 어디쯤인가이고 이것은 다음 학기로 보내도
            되는가라, 섞으면 잘하는 학생에게 낮은 등급이 찍힙니다.
          </li>
          <li>
