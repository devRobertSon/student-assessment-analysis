    ...
    <div className="assess-pane manual">
      ...
      <section className="assess-card">
        ...
        <p className="muted">
          ...
          넷만으로는 한 영역에 문항이 몰려 어느 지점에서 막혔는지 알기 어렵습니다. 각 영역을
          <b>서로 다른 두 힘</b>으로 나누어 여덟 가지로 씁니다. 중학교에서 쓰다가 고등·수능까지 그대로 이어집니다.
        </p>
        ...
        <ul className="bullets type-guide">
          <li>
            ...
            <p>연산 법칙과 성질을 써서 식을 정확히 정리하는 힘입니다. 아는데 틀리는 자리입니다.</p>
            <p className="tg-train">
              <b>훈련</b> 틀린 문제를 다시 풀리지 말고 <b>어느 줄에서 어긋났는지 찾게</b> 하세요. 부호인지 분배인지
              통분인지를 학생이 짚어야 합니다. 열 문항을 빨리 푸는 것보다 다섯 문항을 검산까지 하는 편이 낫습니다.
            </p>
          </li>
          <li>
            <b>공식 활용</b> <span className="tg-area">계산</span>
            <p>어떤 공식이나 정해진 절차를 꺼내 쓸지 고르고, 그대로 적용하는 힘입니다.</p>
            <p className="tg-train">
          ...
          <li>
            ...
            <p className="tg-train">
              ...
              수&apos;까지 나와야 합니다. 반례를 하나 들어 보라고 하면 아는지 외웠는지 바로 드러납니다.
            </p>
          </li>
          <li>
            <b>표현 해석</b> <span className="tg-area">이해</span>
            <p>
              그래프·표·전개도·새로 정의된 기호처럼 <b>이미 수학으로 적혀 있는 것</b>을 읽어 내는 힘입니다. 말로 된
          ...
          <li>
            ...
            <p className="tg-train">
              ...
              규칙이 보입니다. 이 습관이 없으면 식을 세우지 못하고 멈춥니다.
            </p>
          </li>
          <li>
            <b>근거 제시</b> <span className="tg-area">추론</span>
            <p>참·거짓을 가리고 왜 그런지 근거를 대는 힘입니다. 반례 찾기, 증명 읽고 결론 내기가 여기 듭니다.</p>
            <p className="tg-train">
              <b>훈련</b> 답이 맞아도 <b>&apos;왜?&apos;를 한 번 더</b> 묻습니다. 틀린 선지에는 반례를 하나씩 들게
              하세요. 반례를 대지 못하면 푼 것이 아니라 찍은 것입니다.
            </p>
          </li>
          <li>
            ...
            <p className="tg-train">
              ...
              대개 첫 단계가 아니라 두 번째 단계를 못 떠올립니다. 풀이를 끊어 번호를 붙이는 습관이 도움이 됩니다.
            </p>
          </li>
          <li>
            <b>식 설정</b> <span className="tg-area">문제 해결</span>
            <p>
              말로 된 상황을 미지수와 식으로 옮기는 힘입니다. 강당에 의자를 놓는 문제, 왕복 속력 문제처럼 아직 수학이
              아닌 것을 수학으로 바꾸는 자리입니다.
            </p>
            <p className="tg-train">
      ...
      <section className="assess-card">
        ...
        <ul className="bullets" style={{ marginTop: 12 }}>
          ...
          <li>
            ...
            최상만 틀리면 8개가 기준선입니다. 쉬운 문제 하나가 어려운 문제 1.6개만큼 무겁습니다.
          </li>
          <li>
          ...
          <li>
            그 아래 <b>기초</b>와 <b>심화</b>를 따로 보여 줍니다. 같은 개수를 틀려도 표준을 틀린 학생과 최상만 못 푼
            학생은 처방이 다릅니다. 표준을 <b>2개 이상</b> 틀리면 <b>기초 미달</b>(지난 학기를 다시 봐야 함),
            최상을 <b>5개 이상</b> 틀리면 <b>심화 미달</b>(더 어려운 문제를 줘야 함)입니다. <b>재수강이 아니어도</b>
            {' '}따로 뜹니다. 최상 5개는 25점이라 통과이지만, 심화가 비어 있는 것은 알아야 합니다.
          </li>
          <li>
            <b>이 판정들은 리포트에 나가지 않습니다.</b> 등급은 전국에서의 위치를 보는 값이고, 이 판정은 다음 학기로 보낼지를
            정하는 값입니다. 섞으면 잘하는 학생에게 낮은 등급이 찍힙니다.
          </li>
          <li>
