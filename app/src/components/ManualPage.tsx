    ...
    <div className="assess-pane manual">
      ...
      <section className="assess-card">
        ...
        <ul className="bullets" style={{ marginTop: 12 }}>
          ...
          <li>
            집계 아래에 <b>학원 기준 판정</b>이 나옵니다. 난이도마다 봐 주는 개수를 따로 두었습니다 —{' '}
            <b>표준·상은 4개까지, 최상은 8개까지</b>. 섞여 틀렸으면 각자 소진한 비율을 더해 100%를 넘으면{' '}
            <b>재수강 권장</b>입니다. 표준·상 2개(50%)에 최상 3개(37.5%)면 87.5%라 통과, 최상을 하나 더 틀리면
            100%가 되어 재수강입니다. 쉬운 문제 한 개가 어려운 문제 두 개만큼 무겁습니다.
          </li>
          <li>
            숫자의 근거입니다. 학원 규칙은 입학 TEST 30문제 중 7개인데, 진단평가는 그보다 쉽습니다 — 입학 TEST 는
            30문제 중 표준이 1문제뿐이고(상 17, 최상 12) 진단평가는 8문제입니다. 난이도 구성으로 환산하면 입학
            TEST 에서 7개를 틀리는 학생이 진단평가에서는 4.7~6.2개를 틀리는데, 이 기준의 통과 상한이 총 3~8개
            (평균 5.3)라 그 값을 거의 그대로 지킵니다.
          </li>
          <li>
            그 아래 <b>기초</b>와 <b>심화</b>를 따로 보여 줍니다. 같은 5개를 틀려도 표준을 흘린 학생과 최상만 못 푼
            학생은 처방이 다릅니다. 표준 정답률이 80%에 못 미치면 <b>기초 미달</b>(지난 학기를 다시 봐야 함),
            최상이 50%에 못 미치면 <b>심화 미달</b>(더 어려운 문제를 줘야 함)입니다. 재수강 여부는 개수로만 정하고,
            이 두 줄은 어디가 비었는지만 가리킵니다.
          </li>
          <li>
