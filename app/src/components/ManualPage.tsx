...
const GRADING_CSV = `학생,시험지,응시일,문항번호,형식,배점,득점,OX
,중1-1 진단평가,2026-09-18,1,객관식,3,,O
,중1-1 진단평가,2026-09-18,2,객관식,3,,X
,중1-1 진단평가,2026-09-18,6,서술형,5,3,`;
    ...
    <div className="assess-pane manual">
        ...
        <table className="assess-table manual-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>필수</td>
              <td>
                <b>무엇을 하다 막히는가.</b> 같은 이름끼리 묶여 정답률이 계산되고, 리포트의 레이더 차트가 됩니다.
              </td>
            </tr>
            <tr>
              <td>단원</td>
              <td>선택</td>
              <td>
                <b>무엇을 안 배웠는가.</b> 적으면 채점 화면 집계에 [단원] 탭이 생깁니다.
              </td>
            </tr>
            <tr>
              <td>난이도</td>
              <td>선택</td>
              <td>
                <b>어디서 멈추는가.</b> <code>표준</code> · <code>상</code> · <code>최상</code>으로 적으면 그 순서대로
                집계되고 리포트 머리줄에 나옵니다.
              </td>
            </tr>
            <tr>
              ...
              <td>선택</td>
              <td>
                <code>서술형</code>이면 채점 때 부분점수 칸이 열립니다. 비우면 객관식입니다.
              </td>
            </tr>
            <tr>
      ...
      <section className="assess-card">
        ...
        <ul className="bullets">
          ...
          <li>
            [시험지] 목록의 <b>인쇄물</b> 칸에서 <b>[＋문제지]</b>를 누르면 올려 둔 파일 목록이 뜹니다. 고르면 그
            자리가 내려받기 단추로 바뀝니다.
          </li>
          <li>
          ...
          <li>
            ✕ 를 누르면 연결만 끊습니다. <b>파일 자체는 지워지지 않습니다.</b>
          </li>
        </ul>
        <div className="assess-warn" style={{ marginTop: 12 }}>
      ...
      <section className="assess-card">
        ...
        <ul className="bullets">
          ...
          <li>한 시험지에 유형이 3개 이상이어야 레이더 차트가 그려집니다. 리포트 1쪽이 이 차트 한 장입니다.</li>
      ...
      <section className="assess-card">
        ...
        <ul className="bullets">
          <li>
            <b>[직접 입력]</b> — 한 문항을 크게 띄웁니다. O나 X를 누르면 바로 다음 문항으로 넘어가므로, 답안지를 보며
            같은 자리에서 손만 움직이면 됩니다. 키보드로도 같습니다 — <code>O</code> <code>X</code>(한글 자판{' '}
          ...
          <li>
            <b>아래 표</b> — 문항마다 O/X를 직접 누릅니다. 몇 개만 고칠 때 빠릅니다. 같은 버튼을 한 번 더 누르면
            미입력으로 되돌아갑니다.
          </li>
          <li>
            <b>[채점 CSV 올리기]</b> — 다른 분이 채점해 왔을 때 씁니다. <b>[채점 CSV 내려받기]</b>로 빈 표를 받아
        ...
        <p className="hint">
          필수는 <b>문항번호</b>와 <b>OX</b>(또는 <b>득점</b>) 둘뿐입니다. 득점을 적으면 그 값이 우선이고, 비우면 OX를
          봅니다. OX 열에는 O/X 외에 1/0, 맞음/틀림, ○/× 도 인식합니다. 빈칸은 미입력으로 둡니다.
        </p>
      ...
      <section className="assess-card">
        ...
        <ul className="bullets">
          ...
          <li>
            <b>1쪽</b>은 유형 레이더 한 장입니다. 여덟 유형의 정답률을 도형으로 보여주고, 각 꼭짓점에{' '}
            <code>25% 약점</code>처럼 글자를 함께 적어 흑백으로 인쇄해도 읽힙니다. 난이도는 머리줄에{' '}
            <code>표준 63% · 상 79% · 최상 57%</code>로 얹힙니다.
          </li>
          <li>
          ...
          <li>
            ...
            잘린 채로 보이므로, 무엇이 인쇄될지는 쓰는 동안 그대로 드러납니다.
          </li>
          <li>
