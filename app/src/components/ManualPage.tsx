    ...
    <div className="assess-pane manual">
      ...
      <section className="assess-card">
        ...
        <ul className="bullets" style={{ marginTop: 12 }}>
          ...
          <li>
            집계 아래에 <b>학원 기준 판정</b>이 나옵니다. 난이도를 가리지 않고 틀린 개수만 세어{' '}
            <b>5개부터 재수강 권장</b>입니다. 학원 규칙은 입학 TEST 30문제 중 7개인데, 진단평가는 그보다 쉬워서
            (입학 TEST 는 30문제 중 표준이 1문제뿐이고 진단평가는 8문제입니다) 같은 학생이 여기서는 덜 틀립니다.
            난이도 구성으로 환산해 5개로 맞춘 것입니다.
          </li>
          <li>
