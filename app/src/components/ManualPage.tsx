...
중1-1 진단평가,수학,1,소인수분해,공식 활용,상,객관식,3,④,심화,3,중1-1_진단평가_문제지.pdf,중1-1_진단평가_해설.pdf,중1-1_진단평가_출제표.csv
중1-1 진단평가,수학,2,소인수분해,근거 제시,상,객관식,3,④,심화,4,,,
    ...
    <div className="assess-pane manual">
      ...
      <section className="assess-card">
        ...
        <p className="hint">
          ...
          CSV로는 넣을 수 없습니다. 학생을 고른 뒤 [학생 정보]에서 적으세요.
        </p>
      ...
      <section className="assess-card">
        <h3>시험지 CSV</h3>
        <p className="muted">
          시험지는 <b>저장소에서만</b> 들어옵니다. 앱에서는 올릴 수 없습니다. 엑셀·구글 시트에서 만들어{' '}
      ...
      <section className="assess-card">
        ...
        <ul className="bullets">
          ...
          <li>
            ...
            휴대폰에서도 내려받지 않습니다. 파일을 받으려면 <b>[다운로드]</b>를 누르세요.
            PDF는 새 탭에서 열리고, <b>출제표 같은 CSV는 앱 안에서 표로 뜹니다.</b> 브라우저가 CSV를 그리지 못하고
            내려받아 버리기 때문입니다.
          </li>
          <li>
            <b>이름을 누르면 고르기 창이 다시 열립니다.</b> 다른 파일로 바꿀 때 씁니다. 지우는 버튼은 넣지 않았습니다.
            옆에 있으면 누르려다 잘못 눌립니다.
          </li>
          <li>
