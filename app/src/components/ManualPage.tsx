    ...
    <div className="assess-pane manual">
      ...
      <section className="assess-card">
        ...
        <ul className="bullets" style={{ marginTop: 12 }}>
          ...
          <li>
            집계 아래에 <b>학원 기준 판정</b>이 나옵니다. 시험지에서 <b>입학 심화형</b>에서 온 문항만 골라 정답률을
            보고, 기준(77%)에 못 미치면 <b>재수강 권장</b>입니다. &apos;심화형 30문제 중 5~7문제를 틀리면 그 학기를
            다시 듣는다&apos;는 학원 규칙을 옮긴 것입니다. <b>이 판정은 리포트에 나가지 않습니다.</b> 등급은 전국에서
            어디쯤인가이고 이것은 다음 학기로 보내도 되는가라, 섞으면 잘하는 학생에게 낮은 등급이 찍힙니다.
          </li>
          <li>
